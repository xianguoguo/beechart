...
(function(h, c) {
    ...
    var k = h.isFunction, d = h.isArray, j = h.each, m = "alicnweb";
    h.noConflict();
    h.ajaxSetup({
        scriptCharset: "gbk",
        cache: true,
    ...
    h.ajaxPrefilter("script jsonp", function(o) {
        o.crossDomain = true;
    });
    h.extend({
        namespace: function() {
            var q = arguments, u, s = 0, r, t, p;
            for (;s < q.length; s++) {
                u = window;
                p = q[s];
                if (p.indexOf(".")) {
        ...
        unparam: function(p, r) {
            ...
            var o = p.trim().match(/([^?#]*)(#.*)?$/), q = {};
            if (!o) {
                return {};
            }
            h.each(o[1].split(r || "&"), function(t, v) {
                if ((v = v.split("="))[0]) {
                    var s = decodeURIComponent(v.shift()), u = v.length > 1 ? v.join("=") : v[0];
                    if (u != c) {
        ...
        methodize: function(t, p, s) {
            ...
            for (var o in t) {
                ...
                if (!s || s[r] != o) {
                    (function(u) {
                        q[u] = function() {
                            var w = [].slice.call(arguments), v = p ? this[p] : this;
    ...
    h.extendIf(h.util, {
        cookie: function(q, s, p) {
            ...
            p = p || {};
            var o, r = p.raw ? function(u) {
                return u;
            } : escape, t = p.raw ? function(u) {
                return u;
            } : unescape;
            return (o = new RegExp("(?:^|; )" + r(q) + "=([^;]*)").exec(document.cookie)) ? t(o[1]) : null;
        },
        subCookie: function(p, q, o) {
            var r = h.unparam(h.util.cookie(m) || "", "|") || {}, o = o || {
                path: "/",
                domain: "alibaba.com",
    ...
    h.extendIf(Array.prototype, {
        ...
        indexOf: function(r, q) {
            q = q || 0;
            for (var p = q, o = this.length; p < o; p++) {
                if (this[p] === r) {
                    return p;
                }
            }
    ...
    if (!(.009.toFixed(2) === "0.01" && .495.toFixed(2) === "0.50")) {
        var b = Number.prototype.toFixed;
        Number.prototype.toFixed = function(p) {
            var o = this, q = Math.pow(10, p || 0);
            o *= q;
            o = Math.round(o);
            o /= q;
            return b.call(o, p);
    ...
    h.EventTarget = {};
    j([ "bind", "trigger", "triggerHandler" ], function() {
        var o = this;
    ...
    var l = document, f = h.util, i = {}, e = {};
    h.extend({
        loadCSS: function(r, v, A) {
            var z = l.getElementsByTagName("head")[0] || l.documentElement, t = z.getElementsByTagName("base"), y = i[r], q;
            if (h.isFunction(v)) {
                A = v;
                v = c;
            }
        ...
        if (r || d(s) || d(v)) {
            ...
            if (x.callbackQueue.length === 1 || x.status === "refresh") {
                var w = 1, o = 0, y = function(q) {
                    ...
                    if (o === w) {
                        x.status = "ready";
                        j(x.callbackQueue, function(B, C) {
                            C(q);
                        });
...
(function(e) {
    ...
    var f = FE.util, d = e.util.cookie, b = e.support;
    f.LoginId = function() {
        var g = d("__cn_logon_id__", {
            raw: true
        });
    ...
    f.loginId = f.LoginId();
    f.IsLogin = function() {
        return f.LoginId() ? true : false;
    };
    f.isLogin = f.IsLogin();
    f.LastLoginId = function() {
        var g = d("__last_loginid__", {
            raw: true
        });
        return g && decodeURIComponent(g);
    };
    f.lastLoginId = f.LastLoginId();
    f.getLastMemberId = function() {
        var g = d("last_mid", {
            raw: true
        });
        return g && decodeURIComponent(g);
    ...
    f.goTo = function(h, k) {
        ...
        k = k || j;
        if (!e.util.ua.ie) {
            return window.open(h, k);
        }
        var i = document.createElement("a"), g = document.body;
        i.setAttribute("href", h);
        i.setAttribute("target", k);
    ...
    e(function() {
        ...
        if (e.JASMINE) {
            ...
            e.use("ext-jasmine-specs", function() {
                e.use("ext-jasmine-html, ext-jasmine-jquery", function() {
                    a.Env = jasmine.getEnv();
                    var g = new jasmine.TrivialReporter();
                    a.Env.addReporter(g);
                    a.Env.specFilter = function(h) {
                        return g.specFilter(h);
                    };
                    c = true;
                });
            });
...
(function(g) {
    ...
    g.styleDomain = "style.china.alibaba.com";
})(jQuery);

"widget" in jQuery || function(a, d) {
    ...
    a.widget = function(f, h, e) {
        ...
        a[g][f].prototype = a.extend(true, i, {
            namespace: g,
            widgetName: f,
            widgetEventPrefix: f,
            widgetBaseClass: j,
    ...
    a.widget.bridge = function(f, e) {
        a.fn[f] = function(i) {
            ...
            if (g) {
                this.each(function() {
                    var k = a.data(this, f), l = k && a.isFunction(k[i]) ? k[i].apply(k, h) : k;
                    if (l !== k && l !== d) {
                        j = l;
                        return false;
                    }
    ...
    a.Widget.prototype = {
        ...
        _init: a.noop,
        _super: function(e) {
            return this.base[e].apply(this, c.call(arguments, 1));
        },
        _superApply: function(f, e) {
            return this.base[f].apply(this, e);
        },
        destroy: function() {
            this._destroy();
        ...
        _trigger: function(f, g, h) {
            ...
            return !(a.isFunction(k) && k.call(this.element[0], g, h) === false || g.isDefaultPrevented());
        }
    };
    a.add("ui-widget");
}(jQuery);

"flash" in jQuery.fn || function(i, h, n) {
    var g = "object", p = "function", d = i.util.ua.ie, j, b, f = {};
    function m(r, q) {
        var e = (r[0] || 0) - (q[0] || 0);
        return e > 0 || !e && r.length > 0 && m(r.slice(1), q.slice(1));
    }
    function c(s) {
        if (typeof s !== g) {
            return s;
    ...
    function l(r) {
        var e = [];
        for (var q in r) {
            e.push([ '<param name="', q, '" value="', c(r[q]), '" />' ].join(""));
        }
        return e.join("");
    }
    try {
        b = n.description || function() {
    ...
    h.flash = {
        ...
        hasVersion: function(e) {
            var q = /string|number/.test(typeof e) ? e.toString().split(".") : /object/.test(typeof e) ? [ e.major, e.minor ] : e || [ 0, 0 ];
            return m(a, q);
        },
        encodeParams: true,
        ...
        create: function(e, r) {
            var q = this;
            if (!r.swf || q.expressInstallIsActive || !q.available && !r.hasVersionFail) {
                return false;
            }
            if (!q.hasVersion(r.hasVersion || 1)) {
                q.expressInstallIsActive = true;
                if (typeof r.hasVersionFail === p) {
                    if (!r.hasVersionFail.apply(r)) {
                        return false;
                    }
                }
                r = {
                    swf: r.expressInstall || q.expressInstall,
                    height: 137,
                    width: 214,
                    flashvars: {
            ...
            j = typeof r.useEncode !== "undefined" ? r.useEncode : q.encodeParams;
            r.wmode = r.wmode || "opaque";
            delete r.hasVersion;
            delete r.hasVersionFail;
            delete r.height;
            delete r.swf;
            delete r.useEncode;
            delete r.width;
            var s = [ "<object ", o(attrs), ">", l(r), "</object>" ].join("");
            if (d) {
        ...
        triggerHandler: function(e) {
            i("#" + e.swfid).triggerHandler(e.type, e);
        }
    };
    i.widget("ui.flash", {
        options: {
        ...
        _create: function() {
            var e = this, r = e.element, t = e.options, s, q = true;
            if (!r[0].id) {
                e._generateId();
            }
            if (t.module && f.hasOwnProperty(t.module)) {
                q = f[t.module].call(e);
            }
            r.addClass("ui-flash");
            if (q) {
                e.obj = h.flash.create(r, e._getFlashConfigs());
                if (!e.obj) {
                    e.destroy();
                }
            }
        ...
        _destroy: function() {
            var e = this, q = e.element;
            if (e.isGenerateId) {
                q.removeAttr("id");
                delete e.isGenerateId;
            }
            delete e.obj;
            q.unbind(".flash").removeClass("ui-flash").empty();
        },
        _generateId: function() {
            this.isGenerateId = true;
            this.element[0].id = "ui-flash" + i.guid;
        },
        getFlash: function() {
            return this.obj;
        },
        _getFlashConfigs: function() {
            var e = i.extend(true, {}, this.options);
            delete e.disabled;
            delete e.module;
            return e;
        }
...
"chart" in jQuery.ui.flash || function(b, d) {
    var c = b.util, a = function() {
        if (c.flash.hasVersion(10)) {
            var g = this, f = g.element[0].id, h = g.options, e = h.swf || c.substitute("http://img.china.alibaba.com/swfapp/chart/yid-chart-{0}.swf", [ h.type ]);
            h = g.options = b.extend(true, {
                width: 700,
                height: 400,
                swf: e,
            ...
            b.extend(g, {
                _getFlashConfigs: function() {
                    var i = this, j;
                    j = b.ui.flash.prototype._getFlashConfigs.call(i);
                    delete j.type;
                    j.flashvars.swfid = f;
                    return j;
                },
                load: function(i, j) {
                    j = j || "utf-8";
                    return this.obj.load(i, j);
                },
                loadCSS: function(i, j) {
                    j = j || "utf-8";
                    return this.obj.loadCSS(i, j);
                },
                parse: function(i) {
                    return this.obj.parse(i);
                },
                parseCSS: function(i) {
                    return this.obj.parseCSS(i);
                },
                setDatasetVisibility: function(i, j) {
                    return this.obj.setDatasetVisibility(i, j);
                },
                getDatasetVisibility: function(i) {
                    return this.obj.getDatasetVisibility(i);
                },
                setDatasetActivity: function(i, j) {
                    return this.obj.setDatasetActivity(i, j);
                },
                getDatasetActivity: function(i) {
                    return this.obj.getDatasetActivity(i);
                }
            });
            return true;
        }
    ...
    c.flash.regist("chart", a);
    b.add("ui-flash-chart");
}(jQuery);
...
(function($) {
    $.anythingSlider = function(el, options) {
        ...
        base.init = function() {
            ...
            base.hovered = false;
            base.panelSize = [];
            base.currentPage = o.startPanel = parseInt(o.startPanel, 10) || 1;
            ...
            base.$items.delegate("a", "focus.AnythingSlider", function(e) {
                var panel = $(this).closest(".panel"), indx = base.$items.index(panel) + base.adj;
        ...
        base.updateSlider = function() {
            ...
            o.showMultiple = parseInt(o.showMultiple, 10) || 1;
            if (o.showMultiple > 1) {
        ...
        base.navWidth = function(x, y) {
            var s = Math.min(x, y), e = Math.max(x, y), w = 0;
            for (;s < e; s++) {
        ...
        base.checkResize = function(stopTimer) {
            ...
            base.resizeTimer = setTimeout(function() {
                var w = base.$outer.width() - base.outerPad[0], h = (base.$outer[0].tagName === "BODY" ? base.$win.height() : base.$outer.height()) - base.outerPad[1];
        ...
        base.setDimensions = function() {
            var w, h, c, leftEdge = 0, pw = o.showMultiple > 1 ? base.width || base.$window.width() / o.showMultiple : base.$window.width(), winw = base.$win.width();
            if (o.expand) {
        ...
        base.setCurrentPage = function(page, move) {
            ...
            if (!o.infiniteSlides && o.stopAtEnd) {
                base.$wrapper.find("span.forward")[page === base.pages ? "addClass" : "removeClass"]("disabled").end().find("span.back")[page === 1 ? "addClass" : "removeClass"]("disabled");
        ...
        base.gotoHash = function() {
            var h = base.win.location.hash, i = h.indexOf("&"), n = h.match(base.regex);
            if (n === null && !/^#&/.test(h)) {
        ...
        base.slideControls = function(toggle) {
            var dir = toggle ? "slideDown" : "slideUp", t1 = toggle ? 0 : o.animationTime, t2 = toggle ? o.animationTime : 0, op = toggle ? 1 : 0, sign = toggle ? 0 : 1;
            if (o.toggleControls) {
...
(function($) {
    ...
    function buildDataAndCSSSwitcher(el, opt) {
        var links = $('<div class="links"></div>').appendTo(el).delegate(".data-links a, .css-links a", "click", function(e) {
    ...
    function buildLinks(el, links, type) {
        ...
        $.each(links, function(index, link) {
            var a = $('<a target="_blank" />').attr("href", link).text(index + 1).addClass(type).appendTo(el);
            if (index === 0) {
                a.addClass("cur");
            }
        });
...
//@ sourceMappingURL=dist/yid-chart-demo-merge.map